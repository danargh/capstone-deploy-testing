...
const InputFileDaftarStr = ({ handleSelectedFile, value }) => {
   ...
   return (
      <>
         <label htmlFor="file-input-str" className="flex flex-row-reverse w-full cursor-pointer h-[41px]">
         ...
         <input required id="file-input-str" className="hidden" type="file" onChange={handleFileChange} />
      </>
   );
};
