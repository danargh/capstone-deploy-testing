   ...
   return (
      <>
         <div className="w-full relative group font-inter font-[400] text-[18px] leading-[27px]">
            <input name={name} onChange={onHandleChange} value={value} type={type} required class="w-full h-12 px-4 text-sm peer bg-white outline-none rounded-lg border-neutral-70 focus:border-none valid:bg-white" />
            <label
               for="username"
