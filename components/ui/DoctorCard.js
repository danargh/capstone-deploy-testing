      ...
      <div className="flex flex-col gap-2.5 items-start justify-start flex-1 relative">
        <div className="flex flex-col gap-2 items-start justify-start shrink-0 relative">
            <div className="flex flex-col gap-2 items-start justify-start shrink-0 relative">
                ...
                <Link 
                    href={href} 
                    className='font-normal font-poppins text-neutral-0 text-left  bg-web-green-300 hover:bg-web-green-400 rounded-xl pt-4 pr-3 pb-4 pl-3 flex flex-row gap-2.5 items-center justify-center shrink-0 w-[84px] h-[31px] relative' 
                    style={{font: "16px/120%"}}
                    prefetch={false}
                >
                    Detail
