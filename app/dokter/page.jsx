  ...
  return (
    ...
    <div className="bg-neutral-0 w-[1440px] h-[1495px] relative overflow-hidden">
      <div className="flex flex-col gap-[31px] items-center justify-start absolute left-14 top-[172px]">
        <div className="flex flex-col gap-[30px] items-end justify-start shrink-0 relative">
          <div className="flex flex-col gap-3.5 items-center justify-start shrink-0 relative">
            <div
              className="font-inter font-semibold text-sm text-neutral-900 text-left relative"
            >
              Konsultasi Dengan Prevent
            </div>

            <div
              className="font-inter font-normal text-xs text-neutral-900 text-left relative"
            >
        ...
        <div
          className="font-inter font-[500px] text-xs text-neutral-900 text-left relative"
        >
      ...
      <div className="flex flex-col gap-[45px] items-start justify-start absolute left-[541px] top-[250px]">
        <div className="flex flex-col gap-[17px] items-start justify-start shrink-0 relative">
          <div className="flex flex-col gap-[15px] items-start justify-start shrink-0 relative">
            <div
              className="font-inter font-[500px] text-lg text-neutral-900 text-left relative w-[254px]"
            >
              Rekomendasi Dokter
            </div>

            <div
              className="font-inter font-normal text-xs text-[rgba(0,0,0,0.62)] text-left relative w-[301px]"
            >
            ...
            {doctor_list.map ((doctor_list) => (
                <>
                <DoctorCard image={TestIMG} name={'Otto Apocalypse, Prime Minister of Austria'} title={'Overseer'} work_time={'500'} href={'/'}/>
      ...
      <div className="w-[419px] h-60 absolute left-16 top-[542px]">
        <div
          className="font-inter font-semibold text-sm text-neutral-900 text-left absolute left-0 top-0"
        >
          Konsultasi Dengan Prevent
        </div>
