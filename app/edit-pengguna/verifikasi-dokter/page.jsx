...
export default function VerifikasiDokter() {
  ...
  useEffect(() => {
    axios
      .get('https://647aaec0d2e5b6101db07ba8.mockapi.io/verif/doktermasuk?status=Terverifikasi')
      .then((response) => setDokterVerif(response.data));
  }, []);

  useEffect(() => {
    axios
      .get('https://647aaec0d2e5b6101db07ba8.mockapi.io/verif/doktermasuk?status=Tolak')
      .then((response) => setDokterTolak(response.data));
  }, []);
