        ...
        <section className="flex bg-gray-500 ">
            ...
            <div className="w-1/2 bg-neutral-0 flex flex-col justify-center">
               ...
               <div className="w-[480px] flex flex-col gap-8 mx-auto text-center">
                  ...
                  {index === 0 && <form onSubmit={() => setIndex(1)} className="flex flex-col gap-8">
                     <Input
                        type="email"
                  ...
                  {index === 1 && <form onSubmit={() => setIndex(2)} className="flex flex-col gap-8">
                     <Input
                        type="text"
                  ...
                  {index === 2 && <form onSubmit={handleFormSubmit} className="flex flex-col gap-4">
                    <div>
