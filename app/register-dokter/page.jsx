...
import { RegisterDokterButton } from "@/components/ui/Button";
         ...
         <section className="min-screen-2xl h-screen flex bg-gray-500 ">
            ...
            <div className="w-1/2 bg-neutral-0 flex flex-col justify-center">
               <motion.div whileInView={{ y: [16, 0], opacity: [0, 1] }} transition={{ duration: 1 }} className="flex mt-5">
                  {index > 0 && (
                     <button className="absolute ml-5 hover:scale-125 transition-transform" onClick={handleBack}>
               ...
               <motion.div whileInView={{ x: [64, 0], opacity: [0, 1] }} transition={{ duration: 1 }} className="w-[480px] flex flex-col gap-4 mx-auto text-center">
                  ...
                  {index === 0 && (
                     <motion.form whileInView={{ y: [16, 0], opacity: [0, 1] }} transition={{ duration: 0.5 }} onSubmit={form1.handleSubmit} className="flex flex-col gap-8">
                        <div>
                        ...
                        <div>
                           <select className={input_variants({ variant: "default" })} name="gender" value={form1.values.gender} onChange={form1.handleChange} onBlur={form1.handleBlur}>
                        ...
                        <div>
                           <input type="date" max="2005-01-01" placeholder="Tanggal Lahir" className={input_variants({ variant: "default" })} name="birth_date" value={form1.values.birth_date} onChange={form1.handleChange} onBlur={form1.handleBlur} />
                  ...
                  {index === 1 && (
                     <motion.form whileInView={{ y: [16, 0], opacity: [0, 1] }} transition={{ duration: 0.5 }} onSubmit={form2.handleSubmit} className="flex flex-col gap-8">
                        <div>
                  ...
                  {index === 2 && (
                     <motion.form whileInView={{ y: [16, 0], opacity: [0, 1] }} transition={{ duration: 0.5 }} onSubmit={handleFormSubmit} className="flex flex-col gap-6">
                        <div>
