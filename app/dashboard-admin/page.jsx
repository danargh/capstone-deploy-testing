            ...
            <div className="flex">
               ...
               <div className=" pl-[68px]">
                  ...
                  <div className="mt-[51px] flex">
                     <div className="w-[293px] h-[299px] border border-[#63863E] border-[5px] rounded-[15px]">
                     ...
                     <div className="w-[293px] h-[299px] mx-[58px] border border-[#63863E] border-[5px] rounded-[15px]">
                        <div className="px-[66px] pt-[10px]">
                           <AdminUserIcon />
                        </div>
