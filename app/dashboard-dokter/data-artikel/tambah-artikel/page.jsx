               ...
               <div className="mx-24" style={{ paddingTop: 17 }}>
                  ...
                  <div className="pb-[39.5px]">
                     ...
                     <div className="flex items-center mb-4">
                        <input id="radio-deperesi" type="radio" value="Depresi" name="kategori" required className="w-6 h-6 text-web-green-400 bg-neutral-0 border-web-green-400 border-2 focus:ring-web-green-500" onChange={(e) => setCategory(e.target.value)} checked={category === "Depresi"} />
                     ...
                     <div className="flex items-center mb-4">
                        <input id="radio-stress" type="radio" value="Stress" name="kategori" required className="w-6 h-6 text-web-green-400 bg-neutral-0 border-web-green-400 border-2 focus:ring-web-green-500" onChange={(e) => setCategory(e.target.value)} checked={category === "Stress"} />
                        <label htmlFor="" className="text-inter ml-3 text-sm font-semibold text-neutral-900 ">
                           Stress
                        </label>
                     </div>
