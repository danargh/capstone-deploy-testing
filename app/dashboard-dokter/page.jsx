...
export default function DashboardDokter() {
   ...
   return (
      <>
         <NavbarDokter />
         {dokterSaldo.map((dokter) => (
            <>
               <div className="">
                  <p className="font-inter text-[22px] font-semibold pt-14 px-14">
                     Hallo, Selamat Datang, Dokter {dokter.nama}
                  </p>
               </div>
                     ...
                     <div className="block max-w-xl p-6 bg-white border-4 border-gray-200S shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <div className="flex justify-center">
                           <div className="mx-4">
                              ...
                              <p className="text-2xl">{dokter.interaksi}</p>
                           </div>
                        </div>
                     </div>
                     <div className="block max-w-xl p-6 bg-white border-4 border-gray-200S shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <div className="flex items-center justify-center">
                           <div className="mx-4">
                              ...
                              <p className="text-2xl">{dokter.totalKomisi}</p>
                           </div>
                        </div>
                     </div>
                  </div>
