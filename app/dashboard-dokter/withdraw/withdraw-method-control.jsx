...
import useWithdrawal, { WithdrawalMethodAtom, selectedDropdownAtom } from '@/components/atoms/useWithdrawal';
         ...
         <div className="flex flex-col gap-[12px] items-start justify-start shrink-0 relative">
            <div className="flex flex-row gap-[57px] items-end justify-center shrink-0 w-[447px] relative">
               <div className="flex flex-row gap-[75px] items-center justify-start shrink-0 w-[447px] relative">
                  <div className="font-inter font-semibold text-lg/[61px] text-[#3a8504] text-center relative">Metode Penarikan</div>
               </div>
            </div>

            <div className="flex flex-col gap-3 items-start justify-start shrink-0 relative">
               <div className="select-none cursor-pointer rounded-lg border-solid border-[#d9d9d9] border-[3px] shrink-0 w-[447px] h-[124px] relative overflow-hidden" onClick={handleBankDropdownClick}>
                  <div className="flex flex-row gap-[239px] items-center justify-start absolute left-[25px] top-2.5">
                     <div className="flex flex-col gap-[11px] items-start justify-center shrink-0 relative">
                        <svg className="shrink-0 relative overflow-visible" width="62" height="72" viewBox="0 0 62 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path
                        ...
                        <div className="font-inter font-medium text-xs/[21px] text-[rgba(0,0,0,0.47)] text-left relative">Bank Transfer</div>
                     </div>

                     <svg className={`shrink-0 relative overflow-visible ${isBankOpen ? 'rotate-180' : ''}`} width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <mask id="mask0_1_151" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="52" height="52">
                           <rect width="52" height="52" fill="#D9D9D9" />
                        </mask>
                        <g mask="url(#mask0_1_151)">
                           <path d="M26 33.3125L13 20.3125L16.0333 17.2792L26 27.2458L35.9667 17.2792L39 20.3125L26 33.3125Z" fill="#1C1B1F" />
                        </g>
                     </svg>
                  </div>
               </div>
                           ...
                           bankLists.map((banks, index) => {
                              return (
                                 <React.Fragment key={index}>
                                    <BankCard bankName={banks.bankName} bankLogo={banks.bankLogo} height={banks.height} width={banks.width} handleWithdrawalOptionSelection={() => handleWithdrawalOptionSelection(banks.bankName)} />
                                 </React.Fragment>
                              );
                           })}
                     </div>
               ...
               >
                  <div className="flex flex-row gap-[239px] items-center justify-start self-stretch shrink-0 relative">
                     <div className="flex flex-col gap-[11px] items-start justify-center flex-1 relative">
                        <svg className="shrink-0 relative overflow-visible" width="84" height="75" viewBox="0 0 84 75" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path
                        ...
                        <div className="font-inter font-medium text-xs/[21px] text-[rgba(0,0,0,0.47)] text-left relative w-[107px]">Virtual Wallet</div>
                     </div>

                     <svg className={`shrink-0 relative overflow-visible ${isVWalletOpen ? 'rotate-180' : ''}`} width="52" height="53" viewBox="0 0 52 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <mask id="mask0_1_160" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="52" height="53">
                           <rect y="0.5" width="52" height="52" fill="#D9D9D9" />
                        </mask>
                        <g mask="url(#mask0_1_160)">
                           <path d="M26 33.8125L13 20.8125L16.0333 17.7792L26 27.7458L35.9667 17.7792L39 20.8125L26 33.8125Z" fill="#1C1B1F" />
                        </g>
                     </svg>
                  </div>
               </div>
