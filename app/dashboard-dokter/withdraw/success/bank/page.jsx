      ...
      <>
         {WithdrawBank.map((withdraw) => (
            <div className="flex flex-col justify-center items-center">
               <Image
                  className="w-[110px] h-[110px] mt-[100px]"
                  src={CheckIcon}
               />
               <p className="font-poppins text-xl font-semibold text-[#039900] mt-[47px]">
                  Transaksi Berhasil
               </p>
               <p className="font-inter text-4xl font-bold">
                  {withdraw.totTransaksi}
               </p>
               <div className="flex flex-col justify-center items-center mt-7 mb-[89px]">
                  <div className="relative top-16">
                     <Image
                        className="rounded-full shadow-md lg:shadow-lg xl:shadow-xl z-10"
                        src={Dokter}
                        alt="Dokter"
                     />
                  ...
                  <div className="w-[1200px] rounded-2xl overflow-hidden border border-gray-400 flex flex-col justify-center items-center">
                     <div className="px-6 py-4">
                        <div className="font-bold text-xl mb-2 items-center justify-center mt-20 text-center">
                           {withdraw.dokter}
                        </div>
                     ...
                     <div className="w-3/4 rounded-2xl overflow-hidden border border-gray-400 mb-[78px]">
                        <div className="px-7 py-4">
                           <p className="text-[32px] font-inter font-semibold text-center">
                              Detail Transaksi
                           </p>
                           <div className="flex flex-wrap justify-between mx-auto p-[10px]">
                              <p className="font-inter font-medium text-[32px] text-gray-400">
                                 Tanggal
                              </p>
                              <p className="font-inter font-medium text-[32px] text-gray-400">
                                 {withdraw.tanggal}
                           ...
                           <div className="flex flex-wrap items-center justify-between mx-auto p-[10px]">
                              ...
                              <div className="flex items-center">
                                 ...
                                 <button
                                    ...
                                    onClick={() =>
                                       handleCopyClick(withdraw.noRef)
                                    }
                                 >
                                    <Salinan />
                                 </button>
                           ...
                           <div className="flex flex-wrap items-center justify-between mx-auto p-[10px]">
                              ...
                              <p className="font-inter font-medium text-[32px] text-gray-400">
                                 {withdraw.biayaTransaki}
                              </p>
                           </div>
                           <div className="border-b-4 border-dashed border-black w-full h-1"></div>
                           <div className="flex flex-wrap items-center justify-between mx-auto p-[10px] mt-9">
                              <p className="font-inter font-semibold text-[32px]">
                                 Total
                              </p>
                              <p className="font-inter font-semibold text-[32px]">
                                 Rp2.007.500
               ...
               <div className="mb-[150px]">
                  <TutupWithdrawButton>
                     <Link href={`/dashboard-dokter`}>Tutup</Link>
                  </TutupWithdrawButton>
               </div>
            </div>
         ))}
